...
- Name: rfqs.spec.js >> RFQ Decision Center >> loads seeded backend RFQs and supports search/filter
- Location: e2e/rfqs.spec.js:4:3
...
Locator: getByText('EuroTech Components').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('EuroTech Components').first()
      ...
      - generic [ref=e70]:
        ...
        - generic [ref=e123]:
          ...
          - generic [ref=e127]:
            - generic [ref=e128]:
              - img [ref=e129]
              - textbox "Search supplier, RFQ, or workflow context" [ref=e132]
            - generic [ref=e133]:
              - img [ref=e134]
              - combobox [ref=e136]:
